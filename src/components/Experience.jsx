...
export default function Experience() {
    ...
    const vexPoint1 = `• Utilized advanced autonomous navigation algorithms in C++ for the Robot Skills Challenge 
          and placed 1st Place globally in the Robot Skills Challenge at the 2025 VEX U World Championship.`;
    ...
    const vexPoint3 = `• Contributed to team’ s achievement of the Excellence Award 
          and 1st Place World Championship Award at the VEX U 2025 World Championship.`;
